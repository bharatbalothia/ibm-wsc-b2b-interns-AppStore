...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:map="http://www.stercomm.com/SI/Map" xmlns:xls="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:xml="http://www.w3.org/XML/1998/namespace" xmlns:xalan="http://xml.apache.org/xalan" exclude-result-prefixes="xalan">
  <xsl:key name="Links" match="map:Field" use="map:Link"/>
  ...
  <!-- XML -->
  <xsl:template match="map:INPUT[map:XMLSyntax]">
    <xsl:element name="worksheet" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
      ...
      <xsl:choose>
        <xsl:when test="not(/map:Mapper/map:OUTPUT/map:XMLSyntax) and (/map:Mapper/map:INPUT/map:XMLSyntax/map:EnableNamespaces = 'yes')">
        ...
        <xsl:when test="/map:Mapper/map:OUTPUT/map:XMLSyntax and (/map:Mapper/map:INPUT/map:XMLSyntax/map:EnableNamespaces = 'yes')">
          <xsl:element name="cols" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:element name="col" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:attribute name="min">1</xsl:attribute>
              <xsl:attribute name="max">2</xsl:attribute>
        ...
        <xsl:when test="not(/map:Mapper/map:OUTPUT/map:XMLSyntax) and (/map:Mapper/map:INPUT/map:XMLSyntax/map:EnableNamespaces = 'no')">
          <xsl:element name="cols" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:element name="col" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:attribute name="min">1</xsl:attribute>
              <xsl:attribute name="max">2</xsl:attribute>
        ...
        <xsl:when test="/map:Mapper/map:OUTPUT/map:XMLSyntax and (/map:Mapper/map:INPUT/map:XMLSyntax/map:EnableNamespaces = 'no')">
          <xsl:element name="cols" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:element name="col" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:attribute name="min">1</xsl:attribute>
              <xsl:attribute name="max">2</xsl:attribute>
      ...
      <xsl:element name="sheetData" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        ...
        <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          ...
          <xsl:if test="not(/map:Mapper/map:OUTPUT/map:XMLSyntax)">
            <xsl:element name="c" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:attribute name="t">inlineStr</xsl:attribute>
              <xsl:attribute name="s">4</xsl:attribute>
              <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                  <xsl:choose>
                    <xsl:when test="/map:Mapper/map:OUTPUT/map:EDISyntax">
          ...
          <xsl:element name="c" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            ...
            <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                <xsl:choose>
                  ...
                  <xsl:when test="/map:Mapper/map:OUTPUT/map:XMLSyntax">
            ...
            <xsl:if test="/map:Mapper/map:INPUT/map:XMLSyntax/map:EnableNamespaces/text() = 'yes'" >
              <!-- namespace -->
              <xsl:element name="c" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                <xsl:attribute name="t">inlineStr</xsl:attribute>
                <xsl:attribute name="s">4</xsl:attribute>
        ...
        <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          ...
          <!-- name -->
            <xsl:element name="c" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              ...
              <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                  <xsl:text>Pre-session Rule</xsl:text>
              </xsl:element>
            </xsl:element>
          </xsl:element>
          <!-- description -->
          ...
          <!-- extended rules -->
            <xsl:element name="c" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              ...
              <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                  <xsl:value-of select="/map:Mapper/map:MapDetails/map:ExplicitRule/map:PreSessionRule" />
                </xsl:element>
              </xsl:element>
            </xsl:element>
          <!-- note -->
  ...
  <!-- Positional -->
  <xsl:template match="map:INPUT[map:PosSyntax]">
      <xsl:element name="worksheet" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        <xsl:element name="sheetViews" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="sheetView" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:attribute name="tabSelected">1</xsl:attribute>
        ...
        <xsl:if test="/map:Mapper/map:OUTPUT/map:XMLSyntax" >
          <xsl:element name="cols" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:element name="col" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:attribute name="min">1</xsl:attribute>
              <xsl:attribute name="max">1</xsl:attribute>
  ...
  <!-- Variable Delimited or EDI -->
  <xsl:template match="map:INPUT[map:EDISyntax or map:VarDelimSyntax]">
      <xsl:element name="worksheet" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        <xsl:element name="sheetViews" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="sheetView" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:attribute name="tabSelected">1</xsl:attribute>
        ...
        <xsl:element name="sheetData" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            ...
            <xsl:element name="c" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              ...
              <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
                  <xsl:value-of select="/map:Mapper/map:MapDetails/map:EDIAssociations_IN/map:BindingID"/>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="/map:Mapper/map:MapDetails/map:EDIAssociations_IN/map:BindingDescription"/>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="/map:Mapper/map:MapDetails/map:EDIAssociations_IN/map:VersionID"/>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="/map:Mapper/map:MapDetails/map:EDIAssociations_IN/map:AgencyDescription"/>
                </xsl:element>
              </xsl:element>
            </xsl:element>
          </xsl:element>
  ...
  <!-- Group -->
  <xsl:template match="map:Group[ancestor::map:INPUT]">
  ...
  <!-- Segment or Record -->
  <xsl:template match="map:Segment[ancestor::map:INPUT] | map:PosRecord[ancestor::map:INPUT] | map:VarDelimRecord[ancestor::map:INPUT]">
    <xsl:if test="$withInactiveFields='yes' or map:Active='1'">
    <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  ...
  <!-- XML Particle -->
  <xsl:template match="map:XMLParticleGroup[ancestor::map:INPUT]">
    <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
      <xsl:attribute name="s">7</xsl:attribute>
      <xsl:attribute name="customFormat">1</xsl:attribute>
      <!-- active -->
      ...
      <xsl:if test="ancestor::map:INPUT/map:XMLSyntax/map:EnableNamespaces/text() = 'yes' or ancestor::map:OUTPUT/map:XMLSyntax/map:EnableNamespaces/text() = 'yes'" >
        <!-- namespace -->
        <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:attribute name="t">inlineStr</xsl:attribute>
          <xsl:attribute name="s">7</xsl:attribute>
  ...
  <!-- Field -->
  <xsl:template match="map:Field[ ancestor::map:INPUT and ( ancestor::map:Segment | ancestor::map:PosRecord | ancestor::map:VarDelimRecord | ancestor::map:ODBCInputRecord ) ]">
    <xsl:if test="$withInactiveFields='yes' or map:Active='1'">
    <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
      <xsl:attribute name="s">1</xsl:attribute>
      <xsl:attribute name="customFormat">1</xsl:attribute>
      ...
      <xsl:if test="not(/map:Mapper/map:OUTPUT/map:XMLSyntax)">
        ...
        <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          ...
          <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:apply-templates select="key('Links', map:ID)" mode="buildRecord"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:if>
      <!-- linked field or XPath -->
      <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        <xsl:attribute name="t">inlineStr</xsl:attribute>
        <xsl:attribute name="s">2</xsl:attribute>
        <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:apply-templates select="key('Links', map:ID)" mode="buildName"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
      <!-- standard rule -->
        ...
        <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:choose>
              ...
              <xsl:when test="ancestor::map:EDISyntax | ancestor::map:VarDelimSyntax | ancestor::map:ODBCInputRecord">
      ...
      <xsl:if test="/map:Mapper/map:INPUT/map:PosSyntax"> 
        <!-- justification -->
        <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:attribute name="t">inlineStr</xsl:attribute>
          <xsl:attribute name="s">1</xsl:attribute>
  ...
  <!-- XML Element -->
  <xsl:template match="map:XMLElementGroup[ancestor::map:INPUT]">
    ...
    <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
      ...
      <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        ...
        <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            ...
            <xsl:text>|-</xsl:text><xsl:value-of select="map:XMLTag"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
      <!-- description -->
      ...
      <xsl:if test="not(/map:Mapper/map:OUTPUT/map:XMLSyntax)" >
        ...
        <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          ...
          <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
              <xsl:apply-templates select="key('Links', map:XMLRecord[map:RecordType='pcdata']/map:ID)" mode="buildRecord"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:if>
      ...
      <xsl:element name="c"  namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        ...
        <xsl:element name="is" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
          <xsl:element name="t" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <xsl:apply-templates select="key('Links', map:XMLRecord[map:RecordType='pcdata']/map:ID)" mode="buildName"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
      <!-- standard rules -->
  ...
  <!-- XML Attribute -->
  <xsl:template match="map:XMLRecord[ancestor::map:INPUT and map:RecordType='attribute']/map:Field">
    <xsl:element name="row" namespace="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
      <xsl:attribute name="s">1</xsl:attribute>
      <xsl:attribute name="customFormat">1</xsl:attribute>
      <xsl:if test="map:Active = 0" >
  ...
  <xsl:template match="map:UseConstant[ancestor::map:INPUT]">
  ...
  <xsl:template match="map:UseUpdate[ancestor::map:INPUT]">
  ...
  <xsl:template match="map:UseSystemVariable[ancestor::map:INPUT]">
    <xsl:text>Use System Variable:</xsl:text>
    <xsl:text disable-output-escaping="yes"><![CDATA[&#10;]]></xsl:text>
    <xsl:text>Current Date and Time</xsl:text>
  </xsl:template>

  <xsl:template match="map:UseSelect[ancestor::map:INPUT]">
    <xsl:param name="useConstantID" select="map:SubTableNameConstantID"/>
  ...
  <xsl:template match="map:UseAccumulator[ancestor::map:INPUT]/map:Accumulator">
  ...
  <xsl:template match="map:UseCode[ancestor::map:INPUT]">
    <xsl:param name="useCodeListTableID" select="map:TableID[ancestor::map:INPUT]"/>
