				...
				<div id="page-bgbtm">
					<div id="content">
						<div class="post">
							...
							<h2 class="date">XSD Creator</h2><hr/>
							<div style="clear: both;">&nbsp;</div>
							<jsp:include page="common\usageType.jsp" />
							<input type="hidden" id="reportType" value="xsdcreate">
						...
						<div class="post">
							...
							<div style="clear: both;">&nbsp;</div>
							<div class="entry">
								<h3 class="date">Create XML Schema (xsd) for corresponding xml file </h3><br>
								<div style="font-size: 15px">
								  <b>Input File Format:&nbsp;</b>.xml / .zip <br>
								  <div style="padding-left: 70px"><b>Output:&nbsp;</b>.xsd</div>
