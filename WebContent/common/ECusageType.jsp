...
<div>
	...
	<br /> <br />
	<div>
		<br />  <label><strong>Select type of envelope : </strong> </label><strong
				style="color: red;">*</strong>
		        <select id="envType">
  				<option value="1">X12 Inbound</option>
  				<option value="2">X12 Outbound</option>
  				<option value="3">Edifact Inbound</option>
  				<option value="4">Edifact Outbound</option>
  				<option value="5">VDA Inbound</option>
  				<option value="6">VDA Outbound</option>
  				<option value="7">Tradacom Inbound</option>
  				<option value="8">Tradacom Outbound</option>
				</select> <br /><br />
	</div>
								...
								.submit(
										function() {
											...
											if ($("#file").val() == null
												...
												if($("#envType").val()==null || $("#envType").val()=="") {
												alert("Please select envelope type");
												return false;
												}
											}
