...
<div>
	...
	<br /> <br />
	<div>
		<br /> <strong>Server URL</strong><strong style="color: red;">*</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="serverURL" id = "serverURL"><br>
			   <strong>Server USERNAME</strong><strong style="color: red;">*</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="uname" id="uname"><br>
			   <strong>Server PASSWORD</strong><strong style="color: red;">*</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="pwd" id="pwd"><br>
								...
								.submit(
										function() {
											...
											if ($("#file").val() == null
												...
												if($("#serverURL").val()==null || $("#serverURL").val()=="" || $("#uname").val()==null || $("#uname").val()=="" || $("#pwd").val()==null || $("#pwd").val()=="") {
												alert("Please provide server details");
												return false;
												}
											}
