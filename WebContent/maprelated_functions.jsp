				...
				<div id="page-bgbtm">
					<div id="content">
						<div class="post">
							...
							<h2 class="date">Map Related Functions</h2><hr/>
							<div style="clear: both;">&nbsp;</div>
							<jsp:include page="common\MRFusageType.jsp" />
							<input type="hidden" id="reportType" value="mapfunctions">
						...
						<div class="post">
							...
							<div style="clear: both;">&nbsp;</div>
							<div class="entry">
								<h3 class="date">It performs map(s) update based on functionality selected. </h3><br>
								<div style="font-size: 15px">
								  <b>Input File Format:&nbsp;</b>.map / .mxl / .zip <br>
								  <div style="padding-left: 70px"><b>Output:&nbsp;</b>.map / .mxl / .zip</div>
