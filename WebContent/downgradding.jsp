				...
				<div id="page-bgbtm">
					<div id="content">
						<div class="post">
							...
							<h2 class="date">Map Editor Version Downgrade</h2><hr/>
							<div style="clear: both;">&nbsp;</div>
							<jsp:include page="common\usageType.jsp" />
							<input type="hidden" id="reportType" value="downgrade">
						...
						<div class="post">
							...
							<div style="clear: both;">&nbsp;</div>
							<div class="entry">
								<h3 class="date">Downgrade map editor version from 8.x to version 5.x</h3><br>
